...
def process_frame(frame):
    ...
    # upper_black = np.array([180, 255, 10], dtype=np.uint8)
    ...
    if blue_contours:
        ...
        if M["m00"] != 0 :
            ...
            center_line = width // 2
            if center_line - 90 <= cx and cx < center_line - 45:
                return "LEFT"
            elif cx < center_line - 90:
                return "LEFT_H"
            elif center_line + 90 >= cx and cx > center_line + 45:
                return "RIGHT"
            elif cx > center_line + 90:
                return "RIGHT_H"
            else :
    ...
    while True:
        ...
        if result and result != state:
            ...
            if result == "LEFT":
                ...
                pub_thread.update(0, 0, 0, 0, 0.00, 0.00)
                pub_thread.update(1, 0, 0, 1, 0.08, 0.5)
