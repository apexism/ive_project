...
# mc.send_angle(6, -15, 20)
# time.sleep(20)

# mc.send_coords([137.2, 1.5, 138.6, -177.64, -2.38, -87.68],5)

# 2024-04-30_촬영 모션 변경 테스트
# mc.send_angles([30, -10, -10, -55, 85, -65], 50)
# time.sleep(2)
...
# mc.send_coords([142.1, 4.5, 308.6, -180, 0.0, -90], 50)
# time.sleep(8)
...
# 드랍 위치 티칭
# mc.send_angles([66, -5, 50, 25, -90, -25], 20)
# time.sleep(5)
# mc.send_coords([0, -230, 30, -180, -0, -180], 20)
# time.sleep(5)
